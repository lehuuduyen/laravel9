    ...
    <div class="text-center">
      ...
      <div class="btn-group clearfix">
        ...
        <label class="btn btn-info btn-aspectRatio" onclick="changeAspectRatio(this, null)">
          {{ trans('filemanager.btn-crop-free') }}
        </label>
      </div>
      <br>
      <br>
      <div class="btn-group clearfix">
        <button class="btn btn-secondary" onclick="loadItems()">{{ trans('filemanager.btn-cancel') }}</button>
        <button class="btn btn-warning" onclick="performCropNew()">{{ trans('filemanager.btn-copy-crop') }}</button>
        <button class="btn btn-primary" onclick="performCrop()">{{ trans('filemanager.btn-crop') }}</button>
      </div>
      <form id='cropForm'>
