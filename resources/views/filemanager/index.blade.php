...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('css/filemanager.min.css') }}">
...
<nav class="navbar sticky-top navbar-expand-lg navbar-dark" id="nav">
    <a class="navbar-brand invisible-lg d-none d-lg-inline" id="to-previous">
        ...
        <span class="d-none d-lg-inline">{{ trans('filemanager.nav-back') }}</span>
    </a>
    ...
    <div class="ml-auto px-2">
        {{--<a class="navbar-link d-none" id="multi_selection_toggle">
            ...
            <span class="d-none d-lg-inline">{{ trans('filemanager.menu-multiple') }}</span>
        </a>--}}
    </div>
        ...
        <ul class="navbar-nav">
            ...
            <li class="nav-item dropdown">
                <a class="nav-link dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">
                    <i class="fa fa-sort fa-fw"></i>{{ trans('filemanager.nav-sort') }}
                </a>
...
<nav class="bg-light fixed-bottom border-top d-none" id="actions">
    <a data-action="open" data-multiple="false"><i class="fa fa-folder-open"></i>{{ trans('filemanager.btn-open') }}
    </a>
    <a data-action="preview" data-multiple="true"><i class="fa fa-images"></i>{{ trans('filemanager.menu-view') }}
    </a>
    <a data-action="use" data-multiple="true"><i class="fa fa-check"></i>{{ trans('filemanager.btn-confirm') }}
    </a>
</nav>
...
<div class="d-flex flex-row">
    ...
    <div id="main">
        ...
        <div id="empty" class="d-none">
            ...
            {{ trans('filemanager.message-empty') }}
        </div>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
                    ...
                    <div class="form-group" id="attachment">
                        <div class="controls text-center">
                            <div class="input-group w-100">
                                <a class="btn btn-primary w-100 text-white" id="upload-button">{{ trans('filemanager.message-choose') }}</a>
                            </div>
                        </div>
                    </div>
            ...
            <div class="modal-footer">
                <button type="button" class="btn btn-secondary w-100" data-dismiss="modal">{{ trans('filemanager.btn-close') }}</button>
            </div>
        </div>
    </div>
</div>
...
<div class="modal fade" id="notify" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                <button type="button" class="btn btn-secondary w-100" data-dismiss="modal">{{ trans('filemanager.btn-close') }}</button>
                <button type="button" class="btn btn-primary w-100" data-dismiss="modal">{{ trans('filemanager.btn-confirm') }}</button>
            </div>
        </div>
    </div>
</div>
...
<script>
    var lang = @json(trans('filemanager'));
    var actions = [
        // {
        //   name: 'use',
        //   icon: 'check',
...
<script src="{{ asset('/js/filemanager.min.js') }}"></script>
