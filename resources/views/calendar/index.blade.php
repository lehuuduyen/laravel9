        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            var calendar = new FullCalendar.Calendar(calendarEl, {
                ...
                eventClick: function(arg) {
                    var event = arg.event;
                    location.href = `/appointments/${event.extendedProps.code}`
                    ...
                    var customHtml =
                        `<div class ="VoOe8c BvZth5"  > 
                            <div class ="LuQ1Ve" > 
                                ...
                                <div class="+uhSCd" id="service-${event.id}" >${event.extendedProps.name}</div> 
                            </div>
                        </div>`
                ...
                eventMouseEnter: function(arg, element, jsEvent, view) {
                    ...
                    var service = $('#service-' + event.id).html()
...
.__react_component_tooltip .multi-line {
  ...
  text-align: center;
                    ...
                    var distanceLeft = $(eleCursor).offset().left;
                    var distanceTop = $(eleCursor).closest('.fc-timegrid-event-harness').offset().top;
                    ...
                    if ($(eleCursor).hasClass('fc-timegrid-slot-lane') || $(eleCursor).hasClass(
                        ...
                        $('.__react_component_tooltip').css('top', distanceTop);
