...
@section('javascript')
    ...
    <script>
        ...
        function setView1(startTime = 0, durationFromService = "", serviceName = "",serviceId ="") {
            ...
            let html = `<div data-qa="appointment-item-section">
                                                        <div class="kmKtqs" currencycode="VND">
                                                            <div class="YgIysy">
                                                                <div class="OCRPjL"></div>
                                                                <div class="Ugknc6">${countView1 + 1}</div>
            ...
            $('.view2').remove();
            $('#view-item-1').append(html)
            $('.select2').select2()
        }

        function setView2(startTime = 0) {
            let html = `<div class="YgIysy view2" style="transform-origin: center top;">
            ...
            $("#view-item-2").html(html)

            $('.select2').select2()
        }

        function getListService(_element) {
                                        ...
                                        <div class="KrH5mo" style="display: flex; flex-direction: column; flex-grow: 1;">
                                            <div class="_06rxAz"
                                                ...
                                                <div class="fM7L52"
                                                    ...
                                                    <div>${valChild.duration_string}</div>
                                                </div>
                                                <div class="P5mq63"
        ...
        $(document).on('click', '._0TvLLS', function(e) {
            ...
            $('.DP71MP').remove()
            let durationFromService = $(this).data('duration') * 60 //minute * 60 = second
            let startTime = $("select[name='" + elementInputStartTime + "']").val()
                                                                            ...
                                                                            <div class="Field_self__b22a9f75 Field_padding__b22a9f75 cssGrid_colspan12__436c4c8b pAfbFK"
                                                                                ...
                                                                                <div
                                                                                    ...
                                                                                    <input autocomplete="off"
                                                                                        ...
                                                                                        readonly="">
                                                                                    <div
                                                                                        class="Input_suffix__03800786 APXB8m">
                                                                                        <span
                                                                                            class="Icon_self__7a585911 Icon_size16__7a585911"><svg
                                                                                                xmlns="http://www.w3.org/2000/svg"
                                                                                                viewBox="0 0 24 24">
                                                                                ...
                                                                                <div class="Field_helperText__b22a9f75"
                                                                                    data-qa="input-hint">duyen le has
                                                                                    another
                                                                                    booking at 11:00, but your team member
                                                                                    can
                                                                                    still double-book appointments for them.
                                                                                </div>
                                                                            </div>
                                                                        ...
                                                                        <div
                                                                            ...
                                                                            <div
                                                                                ...
                                                                                <select class="Select_select__eeee3dfd"
                                                                                    ...
                                                                                    <option value="4200">1h 10min
                                                                                    </option>
                                                                                    <option value="4500">1h 15min
                                                                                    </option>
                                                                                    <option value="4800">1h 20min
                                                                                    </option>
                                                                                    <option value="5100">1h 25min
                                                                                    </option>
                                                                                    <option value="5400">1h 30min
                                                                                    </option>
                                                                                    <option value="5700">1h 35min
                                                                                    </option>
                                                                                    <option value="6000">1h 40min
                                                                                    </option>
                                                                                    <option value="6300">1h 45min
                                                                                    </option>
                                                                                    <option value="6600">1h 50min
                                                                                    </option>
                                                                                    <option value="6900">1h 55min
                                                                                    </option>
                                                                                    <option value="7200">2h</option>
                                                                                    <option value="8100">2h 15min
                                                                                    </option>
                                                                                    <option value="9000">2h 30min
                                                                                    </option>
                                                                                    <option value="9900">2h 45min
                                                                                    </option>
                                                                                    <option value="10800">3h</option>
                                                                                    <option value="11700">3h 15min
                                                                                    </option>
                                                                                    <option value="12600">3h 30min
                                                                                    </option>
                                                                                    <option value="13500">3h 45min
                                                                                    </option>
                                                                                    <option value="14400">4h</option>
                                                                                    <option value="16200">4h 30min
                                                                                    </option>
                                                                                    <option value="18000">5h</option>
                                                                                    <option value="19800">5h 30min
                                                                                    </option>
                                                                                    <option value="21600">6h</option>
                                                                                    <option value="23400">6h 30min
                                                                                    </option>
                                                                                    <option value="25200">7h</option>
                                                                                    <option value="27000">7h 30min
                                                                                    </option>
